...
| [Gestor NetBox](services/netbox-manager/) | Linux/systemd | Opera uma instalação NetBox existente: atualizações, plugins, validação, backups e controlo de serviços |
